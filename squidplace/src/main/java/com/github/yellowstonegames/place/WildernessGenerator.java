...
//                    return new ObjectList<>(0);
    ...
    public static ObjectLongOrderedMap<String> defaultViewer(){
        ...
        viewer.put("snow path", '.' | (long)describeOklab("light dullmost silver") << 32 | 0x300000L);
        viewer.put("dirt path", '.' | (long)describeOklab("lightmost dullest chocolate") << 32 | 0x300000L);
        viewer.put("sand path", '.' | (long)describeOklab("dark dullmost butter") << 32 | 0x300000L);
        viewer.put("grass path", '.' | (long)describeOklab("darker dullmost lime") << 32 | 0x300000L);
        viewer.put("stone path", '.' | (long)describeOklab("lightmost dullest cyan") << 32 | 0x300000L);
        viewer.put("wooden bridge", ':' | (long)describeOklab("dark dullmost ember") << 32 | 0x300000L);
        viewer.put("ice ledge", '¬' | (long)describeOklab("lightest dullmost cyan") << 32 | 0x300000L);
        viewer.put("dirt ledge", '¬' | (long)describeOklab("dark duller chocolate") << 32 | 0x300000L);
        viewer.put("sand ledge", '¬' | (long)describeOklab("dark dullmost saffron") << 32 | 0x300000L);
        viewer.put("grass ledge", '¬' | (long)describeOklab("darker dull moss") << 32 | 0x300000L);
        viewer.put("stone ledge", '¬' | (long)describeOklab("lighter dullmost cobalt") << 32 | 0x300000L);
        viewer.put("snow", '…' | (long)describeOklab("lightmost dullmost sky white") << 32 | 0x300000L);
        viewer.put("ice", '-' | (long)describeOklab("lightmost dull mint") << 32 | 0x300000L);
        viewer.put("dirt", '·' | (long)describeOklab("dark duller cinnamon brown") << 32 | 0x300000L);
        viewer.put("pebbles", '…' | (long)describeOklab("dark dullmost peach") << 32 | 0x300000L);
        viewer.put("dry grass", '\'' | (long)describeOklab("lighter duller brown") << 32 | 0x300000L);
        viewer.put("fresh water", '~' | (long)describeOklab("rich denim") << 32 | 0x300000L);
        viewer.put("salt water", '≈' | (long)describeOklab("dull cobalt") << 32 | 0x300000L);
        viewer.put("sand", '…' | (long)describeOklab("lightest dullest butter") << 32 | 0x300000L);
        viewer.put("leaves", '…' | (long)describeOklab("pear chocolate brown") << 32 | 0x300000L);
        viewer.put("grass", '"' | (long)describeOklab("darkest dullest green") << 32 | 0x300000L);
        viewer.put("mud", ',' | (long)describeOklab("dull chocolate") << 32 | 0x300000L);
        viewer.put("moss", '˝' | (long)describeOklab("darkest fern") << 32 | 0x300000L);
        viewer.put("rubble", '‰' | (long)describeOklab("dullmost tan turquoise") << 32 | 0x300000L);
        viewer.put("empty space", ' ' | (long)describeOklab("darkest dullmost indigo") << 32 | 0x300000L);
        viewer.put("snow mound", '∆' | (long)describeOklab("lightmost dullmost sky") << 32 | 0x300000L);
        viewer.put("icy divot", '°' | (long)describeOklab("lighter white denim") << 32 | 0x300000L);
        viewer.put("powder snowdrift", '¨' | (long)describeOklab("lightmost rich silver") << 32 | 0x300000L);
        viewer.put("hillock", '∆' | (long)describeOklab("lighter dullest pear") << 32 | 0x300000L);
        viewer.put("animal burrow", '¸' | (long)describeOklab("darkest duller lime") << 32 | 0x300000L);
        viewer.put("small bush 1", '♣' | (long)describeOklab("darkest duller pear") << 32 | 0x300000L);
        viewer.put("large bush 1", '♣' | (long)describeOklab("darker richer fern") << 32 | 0x300000L);
        viewer.put("evergreen tree 1", '♠' | (long)describeOklab("darkest green") << 32 | 0x300000L);
        viewer.put("evergreen tree 2", '♠' | (long)describeOklab("darkmost dullmost black") << 32 | 0x300000L);
        viewer.put("small cactus 1", '‡' | (long)describeOklab("light rich cactus") << 32 | 0x300000L);
        viewer.put("large cactus 1", '‡' | (long)describeOklab("darker duller celery") << 32 | 0x300000L);
        viewer.put("succulent 1", '§' | (long)describeOklab("light rich jade") << 32 | 0x300000L);
        viewer.put("seashell 1", 'ˋ' | (long)describeOklab("lightest dullest saffron") << 32 | 0x300000L);
        viewer.put("seashell 2", 'ˋ' | (long)describeOklab("lightmost dullest tan") << 32 | 0x300000L);
        viewer.put("seashell 3", 'ˋ' | (long)describeOklab("lightmost dullest yellow") << 32 | 0x300000L);
        viewer.put("seashell 4", 'ˋ' | (long)describeOklab("lightest dullest pink") << 32 | 0x300000L);
        viewer.put("driftwood", '¿' | (long)describeOklab("dullmost gray") << 32 | 0x300000L);
        viewer.put("boulder", '●' | (long)describeOklab("lighter dullmost teal") << 32 | 0x300000L);
        viewer.put("deciduous tree 1", '¥' | (long)describeOklab("darker dull olive") << 32 | 0x300000L);
        viewer.put("small bush 2", '♣' | (long)describeOklab("darkest duller pear") << 32 | 0x300000L);
        viewer.put("deciduous tree 2", '¥' | (long)describeOklab("dark cactus") << 32 | 0x300000L);
        viewer.put("deciduous tree 3", '¥' | (long)describeOklab("lightest moss") << 32 | 0x300000L);
        viewer.put("large bush 2", '♣' | (long)describeOklab("darker dullmost green") << 32 | 0x300000L);
        viewer.put("tropical tree 1", '¶' | (long)describeOklab("richest fern") << 32 | 0x300000L);
        viewer.put("tropical tree 2", '¶' | (long)describeOklab("dull fern") << 32 | 0x300000L);
        viewer.put("large bush 3", '♣' | (long)describeOklab("duller cactus") << 32 | 0x300000L);
        viewer.put("tropical tree 3", '¶' | (long)describeOklab("richmost fern") << 32 | 0x300000L);
        viewer.put("tropical tree 4", '¶' | (long)describeOklab("light rich cactus") << 32 | 0x300000L);

        //// old values
//        viewer.put("snow path", '.' | (long)describe("lightest silver") << 32 | 0x300000L);
//        viewer.put("dirt path", '.' | (long)describe("lighter dullmost brick") << 32 | 0x300000L);
//        viewer.put("sand path", '.' | (long)describe("lightmost dullmost bronze") << 32 | 0x300000L);
//        viewer.put("grass path", '.' | (long)describe("lighter dullmost fern") << 32 | 0x300000L);
//        viewer.put("stone path", '.' | (long)describe("lighter dullmost cyan") << 32 | 0x300000L);
//        viewer.put("wooden bridge", ':' | (long)describe("darkest dullmost sage") << 32 | 0x300000L);
//        viewer.put("ice ledge", '¬' | (long)describe("lightmost dullmost cyan") << 32 | 0x300000L);
//        viewer.put("dirt ledge", '¬' | (long)describe("darkmost dullmost ember") << 32 | 0x300000L);
//        viewer.put("sand ledge", '¬' | (long)describe("dullest tan") << 32 | 0x300000L);
//        viewer.put("grass ledge", '¬' | (long)describe("darkmost dullmost fern") << 32 | 0x300000L);
//        viewer.put("stone ledge", '¬' | (long)describe("lighter dullmost fern") << 32 | 0x300000L);
//        viewer.put("snow", '…' | (long)describe("dullmost white") << 32 | 0x300000L);
//        viewer.put("ice", '-' | (long)describe("rich white") << 32 | 0x300000L);
//        viewer.put("dirt", '·' | (long)describe("lighter duller chocolate") << 32 | 0x300000L);
//        viewer.put("pebbles", '…' | (long)describe("lighter dullmost mauve") << 32 | 0x300000L);
//        viewer.put("dry grass", '\'' | (long)describe("light dullmost saffron") << 32 | 0x300000L);
//        viewer.put("fresh water", '~' | (long)describe("lightmost duller navy") << 32 | 0x300000L);
//        viewer.put("salt water", '≈' | (long)describe("light duller cobalt") << 32 | 0x300000L);
//        viewer.put("sand", '…' | (long)describe("lightest dullest butter") << 32 | 0x300000L);
//        viewer.put("leaves", '…' | (long)describe("darker dull peach") << 32 | 0x300000L);
//        viewer.put("grass", '"' | (long)describe("dark dullmost cactus") << 32 | 0x300000L);
//        viewer.put("mud", ',' | (long)describe("darkmost dullest peach") << 32 | 0x300000L);
//        viewer.put("moss", '˝' | (long)describe("darker dullmost cactus") << 32 | 0x300000L);
//        viewer.put("rubble", '‰' | (long)describe("dark dullmost cyan") << 32 | 0x300000L);
//        viewer.put("empty space", ' ' | (long)describe("lighter rich black") << 32 | 0x300000L);
//        viewer.put("snow mound", '∆' | (long)describe("lightest dullmost sage") << 32 | 0x300000L);
//        viewer.put("icy divot", '°' | (long)describe("rich white") << 32 | 0x300000L);
//        viewer.put("powder snowdrift", '¨' | (long)describe("lightmost dullmost sage") << 32 | 0x300000L);
//        viewer.put("hillock", '∆' | (long)describe("lighter dullmost saffron") << 32 | 0x300000L);
//        viewer.put("animal burrow", '¸' | (long)describe("darkmost dullmost silver") << 32 | 0x300000L);
//        viewer.put("small bush 1", '♣' | (long)describe("darkmost dullmost chartreuse") << 32 | 0x300000L);
//        viewer.put("large bush 1", '♣' | (long)describe("darkest dullmost cactus") << 32 | 0x300000L);
//        viewer.put("evergreen tree 1", '♠' | (long)describe("darkest silver") << 32 | 0x300000L);
//        viewer.put("evergreen tree 2", '♠' | (long)describe("darkmost dullmost black") << 32 | 0x300000L);
//        viewer.put("small cactus 1", '‡' | (long)describe("light duller jade") << 32 | 0x300000L);
//        viewer.put("large cactus 1", '‡' | (long)describe("lighter duller fern") << 32 | 0x300000L);
//        viewer.put("succulent 1", '§' | (long)describe("lightmost dullest cactus") << 32 | 0x300000L);
//        viewer.put("seashell 1", 'ˋ' | (long)describe("lighter dullest butter") << 32 | 0x300000L);
//        viewer.put("seashell 2", 'ˋ' | (long)describe("lightmost dullest salmon") << 32 | 0x300000L);
//        viewer.put("seashell 3", 'ˋ' | (long)describe("dullmost white") << 32 | 0x300000L);
//        viewer.put("seashell 4", 'ˋ' | (long)describe("lightmost dullest lavender") << 32 | 0x300000L);
//        viewer.put("driftwood", '¿' | (long)describe("darkest white") << 32 | 0x300000L);
//        viewer.put("boulder", '●' | (long)describe("dark silver") << 32 | 0x300000L);
//        viewer.put("deciduous tree 1", '¥' | (long)describe("darkmost dullmost lime") << 32 | 0x300000L);
//        viewer.put("small bush 2", '♣' | (long)describe("dullmost brown") << 32 | 0x300000L);
//        viewer.put("deciduous tree 2", '¥' | (long)describe("darkest dullmost green") << 32 | 0x300000L);
//        viewer.put("deciduous tree 3", '¥' | (long)describe("darkest dullmost butter") << 32 | 0x300000L);
//        viewer.put("large bush 2", '♣' | (long)describe("darker silver") << 32 | 0x300000L);
//        viewer.put("tropical tree 1", '¶' | (long)describe("darkest dullest sage") << 32 | 0x300000L);
//        viewer.put("tropical tree 2", '¶' | (long)describe("light dullmost fern") << 32 | 0x300000L);
//        viewer.put("large bush 3", '♣' | (long)describe("dark dullmost lime") << 32 | 0x300000L);
//        viewer.put("tropical tree 3", '¶' | (long)describe("lighter dullmost fern") << 32 | 0x300000L);
//        viewer.put("tropical tree 4", '¶' | (long)describe("lightest dull fern") << 32 | 0x300000L);

...
//                new String[]{"foo", "bar", "baz"});
    ...
    public void testCoordLongMap() {
        ...
        CoordLongMap points = CoordLongMap.with(Coord.get(42, 42), 4242, Coord.get(23, 23), 2323, Coord.get(66, 66), 6666);
        String data = json.toJson(points);
        System.out.println(data);
    ...
    public void testCoordLongOrderedMap() {
        ...
        CoordLongOrderedMap points = CoordLongOrderedMap.with(Coord.get(42, 42), 4242, Coord.get(23, 23), 2323, Coord.get(66, 66), 6666);
        String data = json.toJson(points);
        System.out.println(data);
    ...
    public void testPuffyNoise() {
        Json json = new Json(JsonWriter.OutputType.minimal);
        JsonGrid.registerPuffyNoise(json);
        PuffyNoise noise, noise2;
        noise = new PuffyNoise(-9876543210L, 4, 0.9f);
        String data = json.toJson(noise);
        System.out.println(data);
        noise2 = json.fromJson(PuffyNoise.class, data);
        Assert.assertEquals(noise, noise2);
        Assert.assertEquals(noise.getNoise(-123f, 0.4f, 0.625f), noise2.getNoise(-123f, 0.4f, 0.625f), Double.MIN_NORMAL);
        System.out.println();
    }
...
//    }
    ...
    public void testBitNoise() {
        Json json = new Json(JsonWriter.OutputType.minimal);
        JsonGrid.registerBitNoise(json);
        BitNoise noise, noise2;
        noise = new BitNoise(-987654321, 8, 3);
        String data = json.toJson(noise);
        System.out.println(data);
        noise2 = json.fromJson(BitNoise.class, data);
        Assert.assertEquals(noise, noise2);
        Assert.assertEquals(noise.getNoise(-123f, 0.4f, 0.625f), noise2.getNoise(-123f, 0.4f, 0.625f), Double.MIN_NORMAL);
        System.out.println();
    }

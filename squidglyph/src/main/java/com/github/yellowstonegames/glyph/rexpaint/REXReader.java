...
public class REXReader {
    private static final IntIntMap cp437ToUnicode = IntIntMap.with(0x00, 0x0000, new int[]{
            0x01, 0x0001, 0x02, 0x0002, 0x03, 0x0003, 0x04, 0x0004, 0x05, 0x0005, 0x06, 0x0006, 0x07, 0x0007,

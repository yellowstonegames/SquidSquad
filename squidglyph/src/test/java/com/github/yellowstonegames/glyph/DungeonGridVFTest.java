...
public class DungeonGridVFTest extends ApplicationAdapter {
    ...
    public static void main(String[] args){
        ...
        new Lwjgl3Application(new DungeonGridVFTest(), config);
    }
...
//        vision.lighting.addLight(player, new Radiance(8, FullPalette.SILVER_GREY, 0f, 0f)); // constant light
        vision.lighting.addLight(player, new Radiance(8, FullPalette.SILVER_GREY, 0.4f, 0f, 0f, 0.4f)); // flickers

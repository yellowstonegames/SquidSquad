...
public class LightingRgbTest extends ApplicationAdapter {
    ...
    private LightingManagerRgb lighting;
    ...
    public static void main(String[] args){
        ...
        new Lwjgl3Application(new LightingRgbTest(), config);
    }
...
//        long seed = TimeUtils.millis() >>> 21; // use to keep each seed for about half an hour; useful for testing
        ...
        stage = new Stage();
        Font font = KnownFonts.getIosevkaSlab(Font.DistanceFieldType.SDF).adjustLineHeight(1.25f);

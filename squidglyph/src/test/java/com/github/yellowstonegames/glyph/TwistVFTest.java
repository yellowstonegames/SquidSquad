...
public class TwistVFTest extends ApplicationAdapter {
    ...
    private TwistedLine playerToCursor;
    ...
    public static void main(String[] args){
        ...
        new Lwjgl3Application(new TwistVFTest(), config);
    }
        ...
        input.setInputProcessor(new InputAdapter(){
            ...
            public boolean mouseMoved(int screenX, int screenY) {
                ...
                if (onGrid(screenX = MathUtils.floor(pos.x), screenY = MathUtils.floor(pos.y))) {
                    ...
                    if(vision.lighting.resistances[screenX][screenY] >= 1f) return false;
                    toCursor.clear();

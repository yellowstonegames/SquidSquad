 ...
 * This tends to look very bubbly and jam-like. When used with ridged or billow modes, this has fewer high or low lines
 * than vanilla simplex noise, while keeping the lines' nice shapes. If patterns are noticeable in some simplex noise

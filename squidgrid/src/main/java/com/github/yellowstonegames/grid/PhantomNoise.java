...
//        return  (result * result * (6.0 - 4.0 * result) - 1.0);
    ...
    public static final PhantomNoise instance2D = new PhantomNoise(goldenLong[2][0], 2);
    public static final PhantomNoise instance3D = new PhantomNoise(goldenLong[3][0], 3);
    public static final PhantomNoise instance4D = new PhantomNoise(goldenLong[4][0], 4);
    public static final PhantomNoise instance5D = new PhantomNoise(goldenLong[5][0], 5);
    public static final PhantomNoise instance6D = new PhantomNoise(goldenLong[6][0], 6);
    public static final PhantomNoise instance7D = new PhantomNoise(goldenLong[7][0], 7);
    public static final PhantomNoise instance8D = new PhantomNoise(goldenLong[8][0], 8);
}

...
/**
 * A variant on jdkgdxds' {@link ObjectIntMap} class that only uses Coord keys, and can do so more efficiently.
 ...
 */
public class CoordIntMap extends ObjectIntMap<Coord> implements ISerializersNeeded {
    public CoordIntMap() {
    ...
    public CoordIntMap(ObjectIntMap<? extends Coord> map) {
        super(map);
    }
     ...
     */
    public static CoordIntMap withNothing () {
        return new CoordIntMap(0);
    }
     ...
     */
    public static CoordIntMap with (Coord key0, Number value0) {
        CoordIntMap map = new CoordIntMap(1);
     ...
     */
    public static CoordIntMap with (Coord key0, Number value0, Coord key1, Number value1) {
        CoordIntMap map = new CoordIntMap(2);
        map.put(key0, value0.intValue());
     ...
     * @return a new map containing the given key-value pairs
     */
    public static CoordIntMap with (Coord key0, Number value0, Coord key1, Number value1, Coord key2, Number value2) {
        CoordIntMap map = new CoordIntMap(3);
        map.put(key0, value0.intValue());
        map.put(key1, value1.intValue());
     ...
     * @return a new map containing the given key-value pairs
     */
    public static CoordIntMap with (Coord key0, Number value0, Coord key1, Number value1, Coord key2, Number value2, Coord key3, Number value3) {
        CoordIntMap map = new CoordIntMap(4);
        map.put(key0, value0.intValue());
        map.put(key1, value1.intValue());
        map.put(key2, value2.intValue());
     ...
     * {@link #CoordIntMap(Coord[], int[])}, which takes all keys and then all values.
     ...
     */
    public static CoordIntMap with (Coord key0, Number value0, Object... rest) {
        CoordIntMap map = new CoordIntMap(1 + (rest.length >>> 1));
        map.put(key0, value0.intValue());
     ...
     * @return a new map containing nothing
     */
    public static CoordIntMap withPrimitive () {
        return new CoordIntMap(0);
    }
     ...
     * @return a new map containing just the entry mapping key0 to value0
     */
    public static CoordIntMap withPrimitive (Coord key0, int value0) {
        CoordIntMap map = new CoordIntMap(1);
        map.put(key0, value0);
        return map;
    }
     ...
     * @return a new map containing the given key-value pairs
     */
    public static CoordIntMap withPrimitive (Coord key0, int value0, Coord key1, int value1) {
        CoordIntMap map = new CoordIntMap(2);
        map.put(key0, value0);
        map.put(key1, value1);
        return map;
     ...
     * @return a new map containing the given key-value pairs
     */
    public static CoordIntMap withPrimitive (Coord key0, int value0, Coord key1, int value1, Coord key2, int value2) {
        CoordIntMap map = new CoordIntMap(3);
        map.put(key0, value0);
        map.put(key1, value1);
        map.put(key2, value2);
     ...
     * @return a new map containing the given key-value pairs
     */
    public static CoordIntMap withPrimitive (Coord key0, int value0, Coord key1, int value1, Coord key2, int value2, Coord key3, int value3) {
        CoordIntMap map = new CoordIntMap(4);
        map.put(key0, value0);
        map.put(key1, value1);
        map.put(key2, value2);
     ...
     * (inclusive) and max (also inclusive), and places them in a newly-allocated CoordIntMap. If you need to
     * get a sorted ordering, use {@link CoordIntOrderedMap#fromArray2D(int[][], int, int)} and sort the result.
     * @param array a usually-rectangular 2D int array
     * @param min the inclusive minimum value
     * @param max the inclusive maximum value
     * @return a new CoordIntMap containing all positions with in-range values, mapped to those values.
     */
    public static CoordIntMap fromArray2D(int[][] array, int min, int max) {
        final int width = array.length;
        CoordIntMap map = new CoordIntMap(width * array[0].length);

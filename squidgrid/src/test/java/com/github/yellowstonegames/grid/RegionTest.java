...
public class RegionTest {
    ...
    public void testExpand8way() {
        ...
        System.out.println("expandSeries8way(3)");
        r.refill(lines, '!');
        Region[] series = r.expandSeries8way(3);
        for (int i = 0; i < series.length; i++) {
            System.out.println(series[i]);
            System.out.println();
        }
        System.out.println("expandSeriesToLimit8way()");
        r.refill(lines, '!');
        ObjectList<Region> limited = r.expandSeriesToLimit8way();
        for(Region reg : limited) {
            System.out.println(reg);
            System.out.println();
        }
    ...
    public void testRetract8way() {
        ...
        System.out.println("retractSeries8way(3)");
        r.refill(lines, '!');
        Region[] series = r.retractSeries8way(3);
        for (int i = 0; i < series.length; i++) {
            System.out.println(series[i]);
            System.out.println();
        }
        System.out.println("retractSeriesToLimit8way()");
        r.refill(lines, '!');
        ObjectList<Region> limited = r.retractSeriesToLimit8way();
        for(Region reg : limited) {
            System.out.println(reg);
            System.out.println();
        }
    ...
    public void testSurface8way() {
        ...
        System.out.println("surfaceSeries8way(3)");
        r.refill(lines, '!');
        Region[] series = r.surfaceSeries8way(3);
        for (int i = 0; i < series.length; i++) {
            System.out.println(series[i]);
            System.out.println();
        }
        System.out.println("surfaceSeriesToLimit8way()");
        r.refill(lines, '!');
        ObjectList<Region> limited = r.surfaceSeriesToLimit8way();
        for(Region reg : limited) {
            System.out.println(reg);
            System.out.println();
        }

 ...
 * The code for techniques, including AOE, is a work-in-progress.
 */
public interface AOE {
     ...
     */
    CoordObjectOrderedMap<ObjectList<Coord>> idealLocations(Collection<Coord> targets, Collection<Coord> requiredExclusions);
     ...
     */
    default Radius getMetric(){
        return getReach().metric;
    }
     ...
     */
    default void setLimitType(AimLimit limitType){
     ...
     * the game, like Radius.SQUARE for Chebyshev distance/8-way movement).
     */
    default void setMetric(Radius metric){
        getReach().metric = metric;
    }

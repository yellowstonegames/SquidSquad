...
public class ZoneOfInfluence {
     ...
     * water as well as walls and floors), and a GridMetric enum that will be used to determine how distance is calculated.
     * <br>
     ...
     * @param radiusStrategy a GridMetric enum that corresponds to how distance should be measured
     */
    public ZoneOfInfluence(Coord[][] influences, char[][] map, GridMetric radiusStrategy) {
     ...
     * as well as walls and floors), and a GridMetric enum that will be used to determine how distance is calculated.
     * <br>
     * Call {@link #calculate()} when you want information out of this.
     ...
     * @param radiusStrategy a GridMetric enum that corresponds to how distance should be measured
     */
    public ZoneOfInfluence(Collection<Coord> influences, char[][] map, GridMetric radiusStrategy) {

...
public class SimpleWorldMapView implements WorldMapView {
    ...
    protected SimpleBiomeMapper biomeMapper;

    public SimpleWorldMapView(){
        this(123, 10, 10);
    }

    public SimpleWorldMapView(WorldMapGenerator worldMapGenerator)
    {
        ...
        this.biomeMapper = new SimpleBiomeMapper();
        initialize();
    }

    public SimpleWorldMapView(long seed, int width, int height)
    {
    ...
    @Override
    public SimpleBiomeMapper getBiomeMapper() {
        return biomeMapper;
    }

    @Override
    public void setBiomeMapper(BiomeMapper biomeMapper) {
        if(biomeMapper instanceof SimpleBiomeMapper)
            this.biomeMapper = (SimpleBiomeMapper) biomeMapper;
    }
    ...
    public String toString() {
        return "SimpleWorldMapView { world: " + world + "}";
    }
}

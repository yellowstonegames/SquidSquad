...
//        height = Base.BASE86.readInt(parts[1]);
    ...
    public boolean equals(Object o) {
        ...
        if(Float.compare(kappa  , that.kappa  ) != 0) return false;
        if(Float.compare(epsilon, that.epsilon) != 0) return false;
    ...
    public String toString() {
        return "HyperellipticalWorldMap { width: " + width + ", height: " + height

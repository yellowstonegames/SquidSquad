...
//    protected static final float terrainFreq = 1.45f, terrainLayeredFreq = 2.6f, heatFreq = 2.1f, moistureFreq = 2.125f, otherFreq = 3.375f;
     ...
     * If you were using {@link EllipticalWorldMap#EllipticalWorldMap(long, int, int, INoise, float)}, then this would be the
     ...
     */
    public EllipticalWorldMap(long initialSeed, int mapWidth, int mapHeight, INoise noiseGenerator) {
     ...
     * @param octaveMultiplier used to adjust the level of detail, with 0.5f at the bare-minimum detail and 1f normal
     */
    public EllipticalWorldMap(long initialSeed, int mapWidth, int mapHeight, INoise noiseGenerator, float octaveMultiplier) {
     ...
     */
    public EllipticalWorldMap(int width, int height, String serialized) {
        super(width, height);
...
//        height = Base.BASE86.readInt(parts[1]);
     ...
     * type with {@link #EllipticalWorldMap(int, int, String)} or (preferably) {@link #recreateFromString(String)}.
     ...
     * {@link #EllipticalWorldMap(int, int, String)}. This stores the last-generated map in this WorldMapGenerator, where
    ...
    public String toString() {
        return "EllipticalWorldMap { width: " + width + ", height: " + height

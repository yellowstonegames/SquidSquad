...
//        height = Base.BASE86.readInt(parts[1]);
     ...
     * type with {@link #TilingWorldMap(int, int, String)} or (preferably) {@link #recreateFromString(String)}.
     ...
     * {@link #TilingWorldMap(int, int, String)}. This stores the last-generated map in this WorldMapGenerator, where
    ...
    public static TilingWorldMap recreateFromString(String data) {
        ...
        return new TilingWorldMap(width, height, data);
    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof TilingWorldMap)) return false;

        TilingWorldMap that = (TilingWorldMap) o;
        // WorldMapGenerator fields:
    ...
    public String toString() {
        return "TilingWorldMap { width: " + width + ", height: " + height

...
public class TilingWorldMap extends WorldMapGenerator {
     ...
     * If you were using {@link TilingWorldMap#TilingWorldMap(long, int, int, Noise, double)}, then this would be the
     ...
     */
    public TilingWorldMap(long initialSeed, int mapWidth, int mapHeight, final Noise noiseGenerator, double octaveMultiplier) {
        ...
        terrain.setFractalOctaves((int) (0.5 + octaveMultiplier * 8));
        ...
        terrainRidged.setFractalOctaves((int) (0.5 + octaveMultiplier * 10));
        ...
        heat.setFractalOctaves((int) (0.5 + octaveMultiplier * 3));
        ...
        moisture.setFractalOctaves((int) (0.5 + octaveMultiplier * 4));
        ...
        otherRidged.setFractalOctaves((int) (0.5 + octaveMultiplier * 6));

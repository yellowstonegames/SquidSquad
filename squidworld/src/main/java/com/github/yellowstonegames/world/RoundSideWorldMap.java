...
public class RoundSideWorldMap extends WorldMapGenerator {
     ...
     */
    public RoundSideWorldMap(int width, int height, String serialized) {
        super(width, height);
...
//        height = Base.BASE86.readInt(parts[1]);
     ...
     * type with {@link #RoundSideWorldMap(int, int, String)} or (preferably) {@link #recreateFromString(String)}.
     ...
     * {@link #RoundSideWorldMap(int, int, String)}. This stores the last-generated map in this WorldMapGenerator, where
    ...
    protected void regenerate(int startX, int startY, int usedWidth, int usedHeight,
        ...
        float p,
                ...
                rx = width * 0.25f - 0.5f, irx = 1.326500428177002f / rx, hw = width * 0.5f,
    ...
    public boolean equals(Object o) {
        if (!(o instanceof RoundSideWorldMap)) return false;

        RoundSideWorldMap that = (RoundSideWorldMap) o;
        // WorldMapGenerator fields:
    ...
    public String toString() {
        return "RoundSideWorldMap { width: " + width + ", height: " + height

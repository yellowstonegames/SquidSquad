...
import static com.github.tommyettinger.anim8.Dithered.DitherAlgorithm.BLUE_NOISE;

/**
 * Writes one or more spinning globes to the out/ folder.
 */
public class AnimatedWorldMapBundleWriter extends ApplicationAdapter {
...
//        StringBuilder sb = new StringBuilder(256 * 12);
        ...
        if(world instanceof RotatingGlobeMapBundle) {
...
//        System.out.println(sb);
    ...
    public static void main(String[] arg) {
        ...
        config.setTitle("Animated World Map BUNDLE Writer");
        config.setWindowedMode(width * cellWidth + 10, height * cellHeight + 10);
        config.setResizable(false);
        config.useVsync(true);
        new Lwjgl3Application(new AnimatedWorldMapBundleWriter(), config);
    }
}

 ...
 * candidate.
 */
public class BlueNoiseGeneralGenerator extends ApplicationAdapter {

    //Took 41471ms to calculate.
...
//    private static final int wrapMask = sector * 5 >>> 5;
    ...
    private final ObjectFloatOrderedMap<Coord> energy = new ObjectFloatOrderedMap<>(sizeSq, 0.5f);
...
//                    r = (r - Math.signum(orig)) * 127.5f + 127.5f;
    ...
    public static void main(String[] arg) {
        ...
        new Lwjgl3Application(new BlueNoiseGeneralGenerator(), config);
    }
}

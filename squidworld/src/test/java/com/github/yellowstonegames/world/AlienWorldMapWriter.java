 ...
 */
public class AlienWorldMapWriter extends ApplicationAdapter {
...
//    private static final boolean FLOWING_LAND = true;
    ...
    {
        return StringTools.capitalize(thesaurus.makePlantName(Language.HLETKIP).replaceAll("'s", "")).replaceAll("\\W", "");
    }
...
//        System.out.println("Remake #" + counter + ", " + name + ", completed in " + (System.currentTimeMillis() - worldTime) + " ms");
    ...
    public static void main(String[] arg) {
        ...
        new Lwjgl3Application(new AlienWorldMapWriter(), config);
    }
}

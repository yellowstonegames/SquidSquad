...
public class SimplexNoiseScaledSerializer extends Serializer<SimplexNoiseScaled> {
    ...
    @Override
    public void write(final Kryo kryo, final Output output, final SimplexNoiseScaled data) {
        output.writeLong(data.getSeed());
    }

    @Override
    public SimplexNoiseScaled read(final Kryo kryo, final Input input, final Class<? extends SimplexNoiseScaled> dataClass) {
        return new SimplexNoiseScaled(input.readLong());
    }

    @Override
    public SimplexNoiseScaled copy(Kryo kryo, SimplexNoiseScaled original) {
        return new SimplexNoiseScaled(original.getSeed());
    }
}

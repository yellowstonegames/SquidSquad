 ...
 * hashed Set or Map with String keys that should use case-insensitive equality/hashing.
 * Created by Tommy Ettinger on 4/15/2017.
 */
public class Hashers {
    private static class CaseInsensitiveStringHasher implements CrossHash.IHasher {
    ...
    private static class CategoryOnlyStringHasher implements CrossHash.IHasher {
    ...
    private static class NoCategoryStringHasher implements CrossHash.IHasher {

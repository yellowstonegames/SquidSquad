 ...
 * but not cryptographic security. NOTE: most of the documentation here is probably very
...
public class CrossHash {
    ...
    private static class Int2DHasher implements IHasher {
    ...
    private static class Long2DHasher implements IHasher {
    ...
    private static class ObjectArrayHasher implements IHasher {
    ...
    private static class MildHasher implements IHasher {
     ...
     * performance in a hash table like most Maps or Sets, unless the objects being hashed have
     * good hashCode() implementations already.
     */
    public static final IHasher mildHasher = new MildHasher();

    private static class IdentityHasher implements IHasher
    {
        IdentityHasher() { }
    ...
    private static class GeneralHasher implements IHasher {
     ...
     * <li>{@link Lightning#hash(int[])}: http://i.imgur.com/afGJ9cA.png</li>
     * </ul>
     */
    ...
    public static final class Lightning {
        ...
        public static long hash64(final double[] data) {
            ...
            long z = 0x632BE59BD9B4E019L, result = 1L;
            for (int i = 0; i < data.length; i++) {
                result ^= (z += (doubleToMixedIntBits(data[i]) + 0x9E3779B97F4A7C15L) * 0xD0E89D2D311E289FL) * 0xC6BC279692B5CC83L;
            }
            return result ^ Long.rotateLeft((z * 0xC6BC279692B5CC83L ^ result * 0x9E3779B97F4A7C15L) + 0x632BE59BD9B4E019L, (int) (z >>> 58));
        }
    ...
    public static final class Wisp {
        ...
        public static long hash64(final double[] data) {
            ...
            final int len = data.length;
            for (int i = 0; i < len; i++) {
                result += (a ^= 0x8329C6EB9E6AD3E3L * doubleToMixedIntBits(data[i]));
            }
            return result * (a | 1L) ^ (result << 37 | result >>> 27);
        }
    ...
    public static final class Mist {
        ...
        public long hash64(final double[] data) {
            ...
            long result = 0x9E3779B97F4A7C94L + l2, a = 0x632BE59BD9B4E019L;
            for (int i = 0; i < len; i++) {
                result += (a ^= 0x8329C6EB9E6AD3E3L * doubleToMixedIntBits(data[i])) ^ l2 * a + l1;
            }
            return result * (a * l1 | 1L) ^ (result << 37 | result >>> 27);
        }
    ...
    public static final class Hive {
        ...
        public static long hash64(final double[] data) {
            ...
            final int len = data.length;
            for (int i = 0; i < len; i++) {
                result ^= (z += (doubleToRawLongBits(data[i]) ^ 0xC6BC279692B5CC85L) * 0x6C8E9CF570932BABL);
                result = (result << 54 | result >>> 10);
            }
            result += (z ^ z >>> 26) * 0x632BE59BD9B4E019L;
            result = (result ^ result >>> 33) * 0xFF51AFD7ED558CCDL;

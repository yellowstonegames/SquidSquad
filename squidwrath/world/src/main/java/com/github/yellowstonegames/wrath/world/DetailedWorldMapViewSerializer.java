...
public class DetailedWorldMapViewSerializer extends Serializer<DetailedWorldMapView> {
    ...
    public void write(MemoryBuffer buffer, DetailedWorldMapView data) {
        ...
        fury.writeRef(buffer, data.BIOME_COLOR_TABLE);
        fury.writeRef(buffer, data.BIOME_DARK_COLOR_TABLE);
    }
    ...
    public DetailedWorldMapView read(MemoryBuffer buffer) {
        ...
        System.arraycopy((int[])fury.readRef(buffer), 0, wmv.BIOME_COLOR_TABLE, 0, 66);
        System.arraycopy((int[])fury.readRef(buffer), 0, wmv.BIOME_DARK_COLOR_TABLE, 0, 66);

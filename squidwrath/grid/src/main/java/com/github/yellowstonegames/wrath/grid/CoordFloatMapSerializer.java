...
public class CoordFloatMapSerializer extends Serializer<CoordFloatMap> {
    ...
    public CoordFloatMapSerializer(Fory fory) {
        super(fory.getConfig(), CoordFloatMap.class);
    }

    @Override
    public void write(final WriteContext output, final CoordFloatMap data) {
    ...
    @Override
    public CoordFloatMap read(ReadContext input) {

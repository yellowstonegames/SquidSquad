 ...
 * a C object; this is typically a method reference, such as to a getter. A Director has an Iterable of C objects,
 ...
 * Iterable, extracts an IGlider from each C, calls {@link IGlider#setChange(float)} on those Gliders with the calculated
 * amount, and potentially calls {@link #stop()} if the animation has completed. You get the Director playing with

...
import static com.github.yellowstonegames.core.Maker.list;
...
public class Thesaurus implements Serializable{
    ...
    /**
     * Constructs a new Thesaurus, seeding its RNG (used to shuffle word order) with shuffleSeedA and shuffleSeedB.
     * @param shuffleSeedA a long for seeding this class' RNG
     * @param shuffleSeedB a long for seeding this class' RNG
     */
...
//        Replacer rep = wordMatch.replacer(new SynonymSubstitution());
    ...
    private static final ObjectList<String> nationTerms = list(
    ...
    private static final ObjectList<String> plantTerms = list(
    ...
    private static final ObjectList<String> fruitTerms = list(
            "fruit`noun` of @",
            "@'s fruit`noun`",
    ...
    private static final ObjectList<String> nutTerms = list(
            "nut`noun` of @",
    ...
    private static final ObjectList<String> flowerTerms = list(
            "flower`noun` of @",
            "sensory`adj` flower`noun` of @",
            "color`adj` flower`noun` of @",
            "@'s flower`noun`",
    ...
    private static final ObjectList<String> potionTerms = list(
    ...
    public static final CaseInsensitiveOrderedMap<ObjectList<String>> categories = Maker.caseInsensitiveOrderedMap(
            "calm`adj`",
            list("harmonious", "peaceful", "pleasant", "serene", "placid", "tranquil", "calm"),
            "calm`noun`",
            list("harmony", "peace", "kindness", "serenity", "tranquility", "calm"),
            "org`noun`",
            list("fraternity", "brotherhood", "order", "group", "foundation", "association", "guild", "fellowship", "partnership"),
            "org`nouns`",
            list("fraternities", "brotherhoods", "orders", "groups", "foundations", "associations", "guilds", "fellowships", "partnerships"),
            "empire`adj`",
            list("imperial", "prince's", "king's", "sultan's", "regal", "dynastic", "royal", "hegemonic", "monarchic", "ascendant", "emir's", "lordly"),
            "empire`noun`",
            list("empire", "emirate", "kingdom", "sultanate", "dominion", "dynasty", "imperium", "hegemony", "triumvirate", "ascendancy", "monarchy", "commonwealth"),
            "empire`nouns`",
            list("empires", "emirates", "kingdoms", "sultanates", "dominions", "dynasties", "imperia", "hegemonies", "triumvirates", "ascendancies", "monarchies", "commonwealths"),
            "emperor`noun`",
            list("emperor", "emir", "king", "sultan", "lord", "ruler", "pharaoh"),
            "emperor`nouns`",
            list("emperors", "emirs", "kings", "sultans", "lords", "rulers", "pharaohs"),
            "empress`noun`",
            list("empress", "emira", "queen", "sultana", "lady", "ruler", "pharaoh"),
            "empress`nouns`",
            list("empresses", "emiras", "queens", "sultanas", "ladies", "rulers", "pharaohs"),
            "union`adj`",
            list("united", "allied", "people's", "confederated", "federated", "congressional", "independent", "associated", "unified", "democratic"),
            "union`noun`",
            list("union", "alliance", "coalition", "confederation", "federation", "congress", "confederacy", "league", "faction", "republic"),
            "union`nouns`",
            list("unions", "alliances", "coalitions", "confederations", "federations", "congresses", "confederacies", "leagues", "factions", "republics"),
            "militia`noun`",
            list("rebellion", "resistance", "militia", "liberators", "warriors", "fighters", "militants", "front", "irregulars"),
            "militia`nouns`",
            list("rebellions", "resistances", "militias", "liberators", "warriors", "fighters", "militants", "fronts", "irregulars"),
            "gang`noun`",
            list("gang", "syndicate", "mob", "crew", "posse", "mafia", "cartel"),
            "gang`nouns`",
            list("gangs", "syndicates", "mobs", "crews", "posses", "mafias", "cartels"),
            "duke`noun`",
            list("duke", "earl", "baron", "fief", "lord", "shogun"),
            "duke`nouns`",
            list("dukes", "earls", "barons", "fiefs", "lords", "shoguns"),
            "duchy`noun`",
            list("duchy", "earldom", "barony", "fiefdom", "lordship", "shogunate"),
            "duchy`nouns`",
            list("duchies", "earldoms", "baronies", "fiefdoms", "lordships", "shogunates"),
            "magical`adj`",
            list("arcane", "enchanted", "sorcerous", "ensorcelled", "magical", "mystical"),
            "holy`adj`",
            list("auspicious", "divine", "holy", "sacred", "prophetic", "blessed", "godly", "virtuous"),
            "priest`noun`",
            list("priest", "bishop", "chaplain", "cleric", "cardinal", "preacher"),
            "priest`nouns`",
            list("priests", "bishops", "chaplains", "clergy", "cardinals", "preachers"),
            "unholy`adj`",
            list("bewitched", "occult", "unholy", "macabre", "accursed", "profane", "vile"),
            "witch`noun`",
            list("witch", "warlock", "necromancer", "cultist", "occultist", "defiler"),
            "witch`nouns`",
            list("witches", "warlocks", "necromancers", "cultists", "occultists", "defilers"),
            "forest`adj`",
            list("natural", "primal", "verdant", "lush", "fertile", "bountiful"),
            "forest`noun`",
            list("nature", "forest", "greenery", "jungle", "woodland", "grove", "copse", "glen"),
            "shaman`noun`",
            list("shaman", "druid", "warden", "animist"),
            "shaman`nouns`",
            list("shamans", "druids", "wardens", "animists"),
            "fancy`adj`",
            list("grand", "glorious", "magnificent", "magnanimous", "majestic", "great", "powerful"),
            "evil`adj`",
            list("heinous", "scurrilous", "terrible", "horrible", "debased", "wicked", "evil", "malevolent", "nefarious", "vile", "cruel", "abhorrent"),
            "villain`noun`",
            list("villain", "knave", "evildoer", "killer", "blasphemer", "monster", "murderer"),
            "villain`nouns`",
            list("villains", "knaves", "evildoers", "killers", "blasphemers", "monsters", "murderers"),
            "monster`noun`",
            list("fiend", "abomination", "demon", "devil", "ghoul", "monster", "beast", "creature"),
            "monsters`nouns`",
            list("fiends", "abominations", "demons", "devils", "ghouls", "monsters", "beasts", "creatures"),
            "good`adj`",
            list("righteous", "moral", "good", "pure", "compassionate", "flawless", "perfect", "kind"),
            "lethal`adj`",
            list("silent", "lethal", "deadly", "fatal", "venomous", "cutthroat", "murderous", "bloodstained", "stalking", "poisonous"),
            "lethal`noun`",
            list("silence", "killer", "assassin", "ninja", "venom", "poison", "snake", "murder", "blood", "razor", "tiger", "slayer"),
            "blade`noun`", // really any melee weapon
            list("blade", "knife", "sword", "axe", "stiletto", "katana", "scimitar", "hatchet", "spear", "glaive", "halberd",
            ...
            list("bow", "longbow", "shortbow", "crossbow", "sling", "atlatl", "bolas", "javelin", "net", "shuriken", "dagger"),
            ...
            "musket`noun`",
            list("arquebus", "blunderbuss", "musket", "matchlock", "flintlock", "wheellock", "cannon"),
            "grenade`noun`",
            list("rocket", "grenade", "missile", "bomb", "warhead", "explosive", "flamethrower"),
            "rifle`noun`",
            list("pistol", "rifle", "handgun", "firearm", "longarm", "shotgun"),
            "blade`nouns`",
            list("blades", "knives", "swords", "axes", "stilettos", "katana", "scimitars", "hatchets", "spears", "glaives", "halberds",
                    "hammers", "mauls", "flails", "maces", "sickles", "scythes", "whips", "lances", "nunchaku", "sabers", "cutlasses", "tridents"),
            "bow`nouns`",
            list("bows", "longbows", "shortbows", "crossbows", "slings", "atlatls", "bolases", "javelins", "nets", "shuriken", "daggers"),
            "weapon`nouns`",
            list("blades", "knives", "swords", "axes", "stilettos", "katana", "scimitars", "hatchets", "spears", "glaives", "halberds",
                    "hammers", "mauls", "flails", "maces", "sickles", "scythes", "whips", "lances", "nunchaku", "sabers", "cutlasses", "tridents",
                    "bows", "longbows", "shortbows", "crossbows", "slings", "atlatls", "bolases", "javelins", "nets", "shuriken", "daggers"),
            "musket`nouns`",
            list("arquebusses", "blunderbusses", "muskets", "matchlocks", "flintlocks", "wheellocks", "cannons"),
            "grenade`nouns`",
            list("rockets", "grenades", "missiles", "bombs", "warheads", "explosives", "flamethrowers"),
            "rifle`nouns`",
            list("pistols", "rifles", "handguns", "firearms", "longarms", "shotguns"),
            "scifi`adj`",
            list("plasma", "warp", "tachyonic", "phase", "gravitational", "photonic", "nanoscale", "laser", "quantum", "genetic"),
            "tech`adj`",
            list("cyber", "digital", "electronic", "techno", "hacker", "crypto", "turbo", "mechanical", "servo"),
            "sole`adj`",
            list("sole", "true", "singular", "total", "ultimate", "final", "last"),
            "light`adj`",
            list("bright", "glowing", "solar", "stellar", "lunar", "radiant", "luminous", "shimmering", "gleaming"),
            "light`noun`",
            list("light", "glow", "sun", "star", "moon", "radiance", "dawn", "torch", "shimmer", "gleam"),
            "light`nouns`",
            list("lights", "glimmers", "suns", "stars", "moons", "torches"),
            "shadow`noun`",
            list("shadow", "darkness", "gloom", "blackness", "murk", "twilight"),
            "shadow`nouns`",
            list("shadows", "darkness", "gloom", "blackness", "murk", "twilight"),
            "fire`noun`",
            list("fire", "flame", "inferno", "conflagration", "pyre", "blaze"),
            "fire`nouns`",
            list("fires", "flames", "infernos", "conflagrations", "pyres", "blazes"),
            "ice`noun`",
            list("ice", "frost", "snow", "chill", "blizzard", "cold"),
            "ice`nouns`",
            list("ice", "frosts", "snow", "chills", "blizzards", "cold"),
            "lightning`noun`",
            list("lightning", "thunder", "thunderbolt", "storm", "spark", "shock"),
            "lightning`nouns`",
            list("lightning", "thunder", "thunderbolts", "storms", "sparks", "shocks"),
            "ground`noun`",
            list("earth", "sand", "soil", "loam", "dirt", "clay", "mud", "peat"),
            "lake`noun`",
            list("puddle", "pond", "lake", "sea", "swamp", "bog", "fen", "glade"),
            "leaf`noun`",
            list("leaf", "bark", "root", "thorn", "seed", "branch", "twig", "wort", "cress", "flower", "wood", "vine", "sap", "bud", "blossom", "shoot", "stalk", "stem"),
            "fruit`noun`",
            list("fruit", "berry", "apple", "peach", "cherry", "melon", "lime", "fig", "date", "mango", "banana", "juniper", "grape", "papaya", "pear", "quince"),
            "nut`noun`",
            list("nut", "bean", "almond", "peanut", "pecan", "walnut", "cashew", "pea", "chestnut", "hazelnut"),
            "flower`noun`",
            list("flower", "rose", "lilac", "orchid", "peony", "oleander", "chrysanthemum", "amaryllis", "camellia", "mallow", "lily", "gardenia", "daisy", "hibiscus", "dandelion", "jasmine", "lotus", "lantana", "phlox", "petunia", "tulip"),
            "tree`noun`",
            list("tree", "oak", "pine", "juniper", "maple", "beech", "birch", "larch", "willow", "alder", "cedar", "palm", "magnolia", "hazel", "cactus", "mangrove", "elm"),
            "flavor`noun`",
            list("sugar", "spice", "acid", "herb", "salt", "grease", "smoke"),
            "flavor`adj`",
            list("sweet", "spicy", "sour", "bitter", "salty", "savory", "smoky"),
            "color`adj`",
            list("black", "white", "red", "orange", "yellow", "green", "blue", "violet", "gray", "brown"),
            "shape`adj`",
            list("hollow", "tufted", "drooping", "fibrous", "giant", "miniature", "delicate", "hardy", "spiny", "thorny", "fragile", "sturdy", "long", "stubby", "stiff", "yielding"),
            "sensory`adj`",
            list("fragrant", "pungent", "rustling", "fuzzy", "glossy", "weeping", "rough", "smooth", "soft", "aromatic"),
            "liquid`noun`",
            list("liquid", "elixir", "tonic", "fluid", "brew", "broth", "potion", "serum"),
            "liquid`adj`",
            list("bubbling", "effervescent", "swirling", "murky", "thick", "congealing", "sloshing", "slimy", "milky"),
            "bottle`noun`",
            list("bottle", "flask", "vial", "jug", "phial", "flagon", "canister"),
            "bottle`adj`",
            list("clear glass", "smoky glass", "green glass", "brown glass", "fluted crystal", "tarnished silver", "dull pewter", "shining silver", "curvaceous glass", "rough-cut glass", "sharp-edged tin"),
            "calabash`adj`",
            list("hollow gourd", "calabash", "milk carton", "waterskin", "wineskin"),
            "smart`adj`",
            list("brilliant", "smart", "genius", "wise", "clever", "cunning", "mindful", "aware"),
            "smart`noun`",
            list("genius", "wisdom", "cunning", "awareness", "mindfulness", "acumen", "smarts", "knowledge"),
            "stupid`adj`",
            list("stupid", "dumb", "idiotic", "foolish", "reckless", "careless", "sloppy", "dull", "moronic", "complacent"),
            "stupid`noun`",
            list("stupidity", "idiocy", "foolishness", "recklessness", "carelessness", "sloppiness", "complacency"),
            "bandit`noun`",
            list("thief", "raider", "bandit", "rogue", "brigand", "highwayman", "pirate"),
            "bandit`nouns`",
            list("thieves", "raiders", "bandits", "rogues", "brigands", "highwaymen", "pirates"),
            "soldier`noun`",
            list("soldier", "warrior", "fighter", "mercenary", "trooper", "combatant"),
            "soldier`nouns`",
            list("soldiers", "warriors", "fighters", "mercenaries", "troops", "combatants"),
            "guard`noun`",
            list("protector", "guardian", "warden", "defender", "guard", "shield", "sentinel", "watchman", "knight", "paladin", "templar"),
            "guard`nouns`",
            list("protectors", "guardians", "wardens", "defenders", "guards", "shields", "sentinels", "watchmen", "knights", "paladins", "templars"),
            "hunter`noun`",
            list("hunter", "poacher", "trapper", "warden", "stalker", "tracker"),
            "explorer`noun`",
            list("explorer", "pathfinder", "seeker", "questant", "wanderer", "nomad"),
            "hunter`nouns`",
            list("hunters", "poachers", "trappers", "wardens", "stalkers", "trackers"),
            "explorer`nouns`",
            list("explorers", "pathfinders", "seekers", "questants", "wanderers", "nomads"),
            "rage`noun`",
            list("rage", "fury", "anger", "wrath", "frenzy", "vengeance"),
            "ominous`adj`",
            list("ominous", "foreboding", "fateful", "baleful", "portentous"),
            "many`adj`",
            list("many", "myriad", "thousandfold", "infinite", "countless", "unlimited", "manifold"),
            "impossible`adj`",
            list("impossible", "forbidden", "incomprehensible", "ineffable", "unearthly", "abominable", "unspeakable", "indescribable"),
            "gaze`noun`",
            list("eye", "gaze", "stare", "observation", "purveyance", "watch"),
            "pain`noun`",
            list("pain", "agony", "misery", "excruciation", "torture"),
            "god`noun`",
            list("god", "deity", "ruler", "king", "father", "lord", "lordship"),
            "goddess`noun`",
            list("goddess", "deity", "ruler", "queen", "mother", "lady", "ladyship"),
            "hero`noun`",
            list("hero", "champion", "savior", "crusader", "knight"),
            "heroes`nouns`",
            list("heroes", "champions", "saviors", "crusaders", "knights"),
            "heroine`noun`",
            list("heroine", "champion", "savior", "crusader", "knight", "maiden"),
            "heroines`nouns`",
            list("heroines", "champions", "saviors", "crusaders", "knights", "maidens"),
            "popular`adj`",
            list("beloved", "adored", "revered", "worshipped"),
            "unpopular`adj`",
            list("reviled", "despised", "hated", "loathed"),
            "glyph`noun`",
            list("glyph", "sign", "symbol", "sigil", "seal", "mark"),
            "glyph`nouns`",
            list("glyphs", "signs", "symbols", "sigils", "seals", "marks"),
            "power`noun`",
            list("power", "force", "potency", "strength", "authority", "dominance"),
            "power`adj`",
            list("powerful", "forceful", "potent", "strong", "authoritative", "dominant"),

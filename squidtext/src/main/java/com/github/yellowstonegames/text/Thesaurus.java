...
//        Replacer rep = wordMatch.replacer(new SynonymSubstitution());
    ...
    public static final CaseInsensitiveOrderedMap<ObjectList<String>> categories = CaseInsensitiveOrderedMap.<ObjectList<String>>with(
            ...
            "nut`noun`",
            with("nut", "bean", "almond", "peanut", "pecan", "walnut", "cashew", "pea", "chestnut", "hazelnut", "lentil", "coconut"),
            "vegetable`noun`",
            with("carrot", "corn", "radish", "potato", "pumpkin", "zucchini", "taro", "yam", "mushroom", "spinach", "lettuce", "cabbage", "kale", "asparagus", "eggplant", "broccoli", "cauliflower", "celery", "beet", "onion", "leek", "truffle", "rutabaga", "artichoke", "avocado", "tomato"),
            "flower`noun`",
            with("flower", "rose", "lilac", "orchid", "peony", "oleander", "chrysanthemum", "amaryllis", "camellia", "mallow", "lily", "gardenia", "daisy", "hibiscus", "dandelion", "jasmine", "lotus", "lantana", "phlox", "petunia", "tulip"),
            "tree`noun`",
            with("tree", "oak", "pine", "juniper", "maple", "beech", "birch", "larch", "willow", "alder", "cedar", "palm", "magnolia", "hazel", "cactus", "mangrove", "elm"),
            "flavor`noun`",

...
public class Mnemonic {
    ...
    /**
     * Directly references the given {@link NumberedSet} instances as the 3-char Strings in items, the adjectives, and
     * the nouns.
     * @param items Must be a non-null NumberedSet, with at least 256 non-null String items
     * @param allAdjectives a NumberedSet of adjective Strings, typically taken from {@link Thesaurus}
     * @param allNouns a NumberedSet of noun Strings, typically taken from {@link Thesaurus}
     */
     ...
     * -8967299915041170097L, respectively. The Strings this method returns are always 24 chars long, and contain only
     * the letters a-z.
     ...
     * long with {@link #fromMnemonic(String)}. Examples of what this can produce are "noahritwimoesaidrubiotso" and
     * "loanuiskohaimrunoizlupwi", generated by a Mnemonic with a seed of 1 from -3743983437744699304L and
     * -8967299915041170097L, respectively. The Strings this method returns are always 24 chars long. If capitalize is
     * true, then the first letter will be a capital letter from A-Z, all other letters will be a-z (including the first
